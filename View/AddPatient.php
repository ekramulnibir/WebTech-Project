...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    if (empty($first_name) || empty($last_name) || empty($email) || empty($gender) || empty($date_of_birth) || empty($blood_group) || empty($address) || empty($password)) {
        ...
        $sql = "INSERT INTO patientinfo (firstname, lastname, email, gender, dob, bg, address, password, picture) VALUES ('$first_name', '$last_name', '$email', '$gender', '$date_of_birth', '$blood_group', '$address', '$Password', '$picture')";
